...
public class Button4 extends JButton
  ...
  ////////////////////////////////////////////////
  public Button4(String strLabel){
    this(strLabel, 0);
  }
  ////////////////////////////////////////////////
  public Button4(String strLabel, int nMinWidth){
    super(strLabel);
  ...
  public static void main(String[] args){
    ...
    frame.getContentPane().add(new Button4("OK", 100));
    frame.getContentPane().add(new Button4("Cancel", 100));
    frame.getContentPane().add(new Button4("Help", 100));
