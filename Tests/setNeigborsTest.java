...
public class setNeigborsTest {
	...
	public void test() {
		...
		assertSame(Field.setNeigbors(testField, 0, 1).nachbar[4], testField[1][0]);
		...
		assertSame(Field.setNeigbors(testField, 0, 2).nachbar[4], testField[1][1]);
		...
		assertSame(Field.setNeigbors(testField, 1, 0).nachbar[4], null);//FALSCH
